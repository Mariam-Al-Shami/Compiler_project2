// Generated from D:/new compiler2/compiler-project-main/grammars/exampleLexer.g4 by ANTLR 4.13.2
...
public class exampleLexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	    ...
	    Token commonToken(int type, String text) {
	        ...
	        // البناء: (المصدر، النوع، القناة، البداية، النهاية)
	        CommonToken t = new CommonToken(source, type, 0, -1, -1);

	        // 3. ضبط النص ومعلومات السطر
	        t.setText(text);
	        t.setLine(getLine());
	    ...
	    public Token nextToken() {
	        // 1. إرجاع التوكنات المخزنة أولاً
	        if (!tokens.isEmpty()) {
	            return tokens.poll();
	        }
	        ...
	        if (_mode == Lexer.DEFAULT_MODE) {
	            // 3. معالجة الأسطر الجديدة للمسافات البادئة (INDENT/DEDENT)
	...
	public static final String _serializedATN =
		...
		"`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001"+
		"`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0001`\u0003`\u03ea\b`\u0001"+
		"a\u0001a\u0001a\u0001a\u0001a\u0001a\u0001b\u0001b\u0001b\u0005b\u03f5"+
		"\bb\nb\fb\u03f8\tb\u0001c\u0004c\u03fb\bc\u000bc\fc\u03fc\u0001d\u0004"+
		"d\u0400\bd\u000bd\fd\u0401\u0001d\u0001d\u0001e\u0001e\u0001e\u0001e\u0005"+
		"e\u040a\be\ne\fe\u040d\te\u0001e\u0001e\u0001e\u0001e\u0001e\u0001f\u0001"+
		"f\u0001f\u0001f\u0002\u02be\u040b\u0000g\u0004\u0003\u0006\u0004\b\u0005"+
		"\n\u0006\f\u0007\u000e\b\u0010\t\u0012\n\u0014\u000b\u0016\f\u0018\r\u001a"+
		"\u000e\u001c\u000f\u001e\u0010 \u0011\"\u0012$\u0013&\u0014(\u0015*\u0016"+
